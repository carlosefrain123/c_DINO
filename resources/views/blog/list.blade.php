                            ...
                            <div class="col-12">
                                <div class="blog-box blog-list wow fadeInUp">
                                    <div class="blog-image">
                                        <img src="{{ asset('storage/' . $post->featured_image) }}" class="img-fluid blur-up lazyload"
                                            alt="">
                                    </div>

                                    <div class="blog-contain blog-contain-2">
                                        <div class="blog-label">
                                            <span class="time"><i data-feather="clock"></i> <span>{{ $post->published_at->format('d M, Y') }}</span></span>
                                            <span class="super"><i data-feather="user"></i> <span>{{ $post->user->name }}</span></span>
                                        </div>
