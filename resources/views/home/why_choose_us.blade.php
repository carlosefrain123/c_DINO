...
<section class="become-service section-b-space" id="why_choose_us">
    <div class="container-fluid-lg">
        <div class="seller-title mb-5">
            <h2 class="text-center" style="color: #ffd60a">¿Por qué unirte a EMPRESA X S.A.C.?</h2>
        </div>
            ...
            <div class="col-xxl-3">
                <div class="service-box">
                    ...
                    <div class="service-detail">
                        ...
                        <p>Ofrecemos tarifas altamente competitivas que garantizan una mayor rentabilidad para nuestros
            ...
            <div class="col-xxl-3">
                <div class="service-box">
                    ...
                    <div class="service-detail">
                        ...
                        <p>Somos una empresa en expansión, comprometida con la innovación y el desarrollo sostenible.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xxl-3">
                <div class="service-box">
                    ...
                    <div class="service-detail">
                        ...
                        <p>Estamos comprometidos con el progreso continuo y la ejecución efectiva de nuestros proyectos.
                        </p>
                    </div>
                </div>
            </div>
   ...
   c16.277-5.525,51.243-15.019,101.995-16.213V309.33z"></path>
                    ...
                    <div class="service-detail">
                        ...
                        <p>Nos esforzamos para que clientes queden plenamente satisfechos, generando
                            confianza y relaciones duraderas.</p>
                    </div>
                </div>
            </div>
        </div>
